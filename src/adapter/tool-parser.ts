 ...
 * </tool_call>
 */
export function parseToolCallsFromText(text: string): { text: string; toolCalls?: ToolCall[] } {
 ...
 */
export function parseToolCallsFromMarkdown(text: string): { text: string; toolCalls?: ToolCall[] } {
 ...
 */
export function extractToolCalls(text: string): { text: string; toolCalls?: ToolCall[] } {
 ...
 */
export function formatToolCallsForOpenAI(toolCalls: ToolCall[]): string {
 ...
 */
export function createToolResultBlock(toolCallId: string, content: string): ContentBlock {
  return {
    type: 'tool_result',
    content,
  };
